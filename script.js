...
const translations = {
    id: {
        ...
        'about.desc1': 'Saya DevOps Engineer berpengalaman lebih dari 5 tahun di lingkungan yang serba cepat dan dinamis, berdedikasi untuk menerapkan teknologi dan praktik mutakhir guna meningkatkan efisiensi sistem dan mempercepat kesuksesan bisnis.',
        'about.desc2': 'Ingin membantu sistem meningkatkan operasinya dengan menerapkan pengetahuan saya tentang pipeline CI/CD, bahasa scripting, containerisasi, arsitektur serverless, dan manajemen infrastruktur cloud. Mengembangkan arsitektur serverless menggunakan Google Cloud dan Google Kubernetes Engine.',
        ...
        'experience.avows.location': 'Penempatan di PT Bank Raya Indonesia Tbk - Jakarta',
        'experience.diksha.location': 'Penempatan di PT Bank Rakyat Indonesia - Jakarta',
        'experience.satkomindo.location': 'Penempatan di PT Bank Rakyat Indonesia - Jakarta',
    ...
    en: {
        ...
        'about.desc1': 'I\'m a DevOps Engineer with over 5 years of experience in fast-paced and dynamic environments, dedicated to implementing cutting-edge technologies and practices to improve system efficiency and accelerate business success.',
        'about.desc2': 'Looking to help systems improve their operations by applying my knowledge of CI/CD pipelines, scripting languages, containerization, serverless architecture, and cloud infrastructure management. Developing serverless architecture using Google Cloud and Google Kubernetes Engine.',
        'about.yearsExp': 'Years Experience',
        'about.companies': 'Companies',
        'about.majorBanks': 'Major Banks',
        'about.downloadCV': 'Download CV',
        'experience.title': 'Work Experience',
        'experience.avows.location': 'Placed at PT Bank Raya Indonesia Tbk - Jakarta',
        'experience.diksha.location': 'Placed at PT Bank Rakyat Indonesia - Jakarta',
        'experience.satkomindo.location': 'Placed at PT Bank Rakyat Indonesia - Jakarta',
